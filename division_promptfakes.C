...
void division_promptfakes()
{
  ...
  TFile* file_hadd= new TFile("code_prompt_electrons/rootFile_8october_PromptFakes/plots__8october_PromptFakes.root");
  ...
  h_div_DY_eta->Draw(); h_div_DY_eta->GetYaxis()->SetRangeUser(0,1); h_div_DY_eta->SetTitle("prompt fake rate"); h_div_DY_eta->GetXaxis()->SetTitle("|Eta2|");h_div_DY_eta->GetYaxis()->SetTitle("Ele fake rate");c4->SetGrid();
