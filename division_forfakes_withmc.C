...
void division_forfakes_withmc(TString dir)
{
  ...
  for(int j=0;j<8;j++){
    ...
    h_GJets_ele[j] = (TH1F*)file_GJets_ele->Get(Form("jetcut_%d/h_pt1_tight_%d",j,j)); 
    ...
    h_denominator_GJets_ele[j] = (TH1F*)file_GJets_ele->Get(Form("jetcut_%d/h_pt1_loose_%d",j,j));
    ...
    h_GJets_eta_ele[j] = (TH1F*)file_GJets_ele->Get(Form("jetcut_%d/h_eta1_tight_%d",j,j));
    ...
    h_denominator_GJets_eta_ele[j] = (TH1F*)file_GJets_ele->Get(Form("jetcut_%d/h_eta1_loose_%d",j,j));
    ...
    h_GJets_mu[j] = (TH1F*)file_GJets_mu->Get(Form("jetcut_%d/h_pt1_tight_%d",j,j)); 
    ...
    h_denominator_GJets_mu[j] = (TH1F*)file_GJets_mu->Get(Form("jetcut_%d/h_pt1_loose_%d",j,j));
    ...
    h_GJets_eta_mu[j] = (TH1F*)file_GJets_mu->Get(Form("jetcut_%d/h_eta1_tight_%d",j,j));
    ...
    h_denominator_GJets_eta_mu[j] = (TH1F*)file_GJets_mu->Get(Form("jetcut_%d/h_eta1_loose_%d",j,j));
    ...
    //FR_pT_eta_num_GJets_ele[j] = (TH2F*)file_GJets_ele->Get(Form("jetcut_%d/h_FR_pT_eta_tight_ele_%d",j,j));
    ...
    //FR_pT_eta_num_GJets_mu[j] = (TH2F*)file_GJets_mu->Get(Form("jetcut_%d/h_FR_pT_eta_tight_mu_%d",j,j));
    ...
    //FR_pT_eta_den_GJets_ele[j] = (TH2F*)file_GJets_ele->Get(Form("jetcut_%d/h_FR_pT_eta_loose_ele_%d",j,j));
    ...
    //FR_pT_eta_den_GJets_mu[j] = (TH2F*)file_GJets_mu->Get(Form("jetcut_%d/h_FR_pT_eta_loose_mu_%d",j,j));
  }
  gStyle->SetOptStat(0);
