...
void division_forfakes_jetbins()
{
  ...
  TFile* file_Data_ele= new TFile("outputsFR_2017_22feb/Data_ele.root");
  TFile* file_DY_ele= new TFile("outputsFR_2017_22feb/DY_ele.root");
  TFile* file_WJets_ele= new TFile("outputsFR_2017_22feb/WJets_ele.root");
  TFile* file_Data_mu= new TFile("outputsFR_2017_22feb/Data_mu.root");
  TFile* file_DY_mu= new TFile("outputsFR_2017_22feb/DY_mu.root");
  TFile* file_WJets_mu= new TFile("outputsFR_2017_22feb/WJets_mu.root");
  ...
  for(int j=0;j<8;j++){
    FR_pt_eta_EWKcorr_numerator_ele[j] = (TH2F*) FR_pt_eta_num_DATA_ele[j]->Clone(Form("FR_pt_eta_EWKcorr_numerator_ele_%d",j));
    ...
    FR_pt_eta_EWKcorr_denominator_ele[j] = (TH2F*) FR_pt_eta_den_DATA_ele[j]->Clone(Form("FR_pt_eta_EWKcorr_denominator_ele_%d",j));
    ...
    FR_pt_eta_EWKcorr_ele[j]= (TH2F*) FR_pt_eta_EWKcorr_numerator_ele[j]->Clone(Form("FR_pt_eta_EWKcorr_ele_%d",j));
    FR_pt_eta_EWKcorr_ele[j]->Divide(FR_pt_eta_EWKcorr_denominator_ele[j]);
    FR_pt_eta_numerator_ele[j] = (TH2F*) FR_pt_eta_num_DATA_ele[j]->Clone(Form("FR_pt_eta_numerator_ele_%d",j));
    FR_pt_eta_denominator_ele[j] = (TH2F*) FR_pt_eta_den_DATA_ele[j]->Clone(Form("FR_pt_eta_denominator_ele_%d",j));
    FR_pt_eta_ele[j]= (TH2F*) FR_pt_eta_numerator_ele[j]->Clone(Form("FR_pt_eta_ele_%d",j));
    FR_pt_eta_ele[j]->Divide(FR_pt_eta_denominator_ele[j]);
    FR_pt_eta_EWKcorr_numerator_mu[j] = (TH2F*) FR_pt_eta_num_DATA_mu[j]->Clone(Form("FR_pt_eta_EWKcorr_numerator_mu_%d",j));
    ...
    FR_pt_eta_EWKcorr_denominator_mu[j] = (TH2F*) FR_pt_eta_den_DATA_mu[j]->Clone(Form("FR_pt_eta_EWKcorr_denominator_mu_%d",j));
    ...
    FR_pt_eta_EWKcorr_mu[j]= (TH2F*) FR_pt_eta_EWKcorr_numerator_mu[j]->Clone(Form("FR_pt_eta_EWKcorr_mu_%d",j));
    FR_pt_eta_EWKcorr_mu[j]->Divide(FR_pt_eta_EWKcorr_denominator_mu[j]);
    FR_pt_eta_numerator_mu[j] = (TH2F*) FR_pt_eta_num_DATA_mu[j]->Clone(Form("FR_pt_eta_numerator_mu_%d",j));
    FR_pt_eta_denominator_mu[j] = (TH2F*) FR_pt_eta_den_DATA_mu[j]->Clone(Form("FR_pt_eta_denominator_mu_%d",j));
    FR_pt_eta_mu[j]= (TH2F*) FR_pt_eta_numerator_mu[j]->Clone(Form("FR_pt_eta_mu_%d",j));
  ...
  h_div_ele[5]->Draw("same"); h_div_ele[5]->SetLineColor(8); h_div_ele[5]->SetMarkerColor(8); h_div_ele[5]->SetLineWidth(2);  h_div_ele[5]->SetMarkerStyle(kFullCircle);
  for(int j=6;j<7;j++){h_div_ele[j]->Draw("same"); h_div_ele[j]->SetLineColor(j); h_div_ele[j]->SetMarkerColor(j); h_div_ele[j]->SetLineWidth(2);  h_div_ele[j]->SetMarkerStyle(kFullCircle);}
  ...
  h_div_mu[5]->Draw("same"); h_div_mu[5]->SetLineColor(8); h_div_mu[5]->SetMarkerColor(8); h_div_mu[5]->SetLineWidth(2);  h_div_mu[5]->SetMarkerStyle(kFullCircle);
  for(int j=6;j<7;j++){h_div_mu[j]->Draw("same"); h_div_mu[j]->SetLineColor(j); h_div_mu[j]->SetMarkerColor(j); h_div_mu[j]->SetLineWidth(2);  h_div_mu[j]->SetMarkerStyle(kFullCircle);}
  ...
  h_div_eta_ele[5]->Draw("same"); h_div_eta_ele[5]->SetLineColor(8); h_div_eta_ele[5]->SetMarkerColor(8); h_div_eta_ele[5]->SetLineWidth(2);  h_div_eta_ele[5]->SetMarkerStyle(kFullCircle);
  for(int j=1;j<5;j++){h_div_eta_ele[j]->Draw("same"); h_div_eta_ele[j]->SetLineColor(j); h_div_eta_ele[j]->SetMarkerColor(j); h_div_eta_ele[j]->SetLineWidth(2);  h_div_eta_ele[j]->SetMarkerStyle(kFullCircle);}
  ...
  h_div_eta_mu[5]->Draw("same"); h_div_eta_mu[5]->SetLineColor(8); h_div_eta_mu[5]->SetMarkerColor(8); h_div_eta_mu[5]->SetLineWidth(2);  h_div_eta_mu[5]->SetMarkerStyle(kFullCircle);
  for(int j=1;j<5;j++){h_div_eta_mu[j]->Draw("same"); h_div_eta_mu[j]->SetLineColor(j); h_div_eta_mu[j]->SetMarkerColor(j); h_div_eta_mu[j]->SetLineWidth(2);  h_div_eta_mu[j]->SetMarkerStyle(kFullCircle);}
  ...
  for(int j=1;j<8;j++){
    ...
    FR_pt_eta_denominator_ele[j]->Write();
    FR_pt_eta_EWKcorr_ele[j]->Write();
    FR_pt_eta_EWKcorr_numerator_ele[j]->Write();
    FR_pt_eta_EWKcorr_denominator_ele[j]->Write();
    root_elefile->Close();

    TFile* root_mufile = new TFile(Form("MuFR_jet%d.root",10+j*5), "recreate");
    FR_pt_eta_mu[j]->Write();  
    FR_pt_eta_numerator_mu[j]->Write(); 
    FR_pt_eta_denominator_mu[j]->Write();
    FR_pt_eta_EWKcorr_mu[j]->Write();
    FR_pt_eta_EWKcorr_numerator_mu[j]->Write();
    FR_pt_eta_EWKcorr_denominator_mu[j]->Write();
    root_mufile->Close();
  }
