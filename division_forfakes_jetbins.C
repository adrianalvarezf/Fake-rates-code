...
void division_forfakes_jetbins()
{
  ...
  TH1F* h_DY_ele[6]; 
  TH1F* h_WJets_ele[6];
  TH1F* h_denominator_DATA_ele[6];
  TH1F* h_denominator_DY_ele[6];
  TH1F* h_denominator_WJets_ele[6];
  TH1F* h_DATA_eta_ele[6];
  TH1F* h_DY_eta_ele[6];
  TH1F* h_WJets_eta_ele[6];
  TH1F* h_denominator_DATA_eta_ele[6];
  TH1F* h_denominator_DY_eta_ele[6];
  TH1F* h_denominator_WJets_eta_ele[6];
  TH1F* h_DATA_mu[6];
  TH1F* h_DY_mu[6]; 
  TH1F* h_WJets_mu[6];
  TH1F* h_denominator_DATA_mu[6];
  TH1F* h_denominator_DY_mu[6];
  TH1F* h_denominator_WJets_mu[6];
  TH1F* h_DATA_eta_mu[6];
  TH1F* h_DY_eta_mu[6];
  TH1F* h_WJets_eta_mu[6];
  TH1F* h_denominator_DATA_eta_mu[6];
  TH1F* h_denominator_DY_eta_mu[6];
  TH1F* h_denominator_WJets_eta_mu[6];
  ...
  gStyle->SetOptStat(0);
  TH1F* h_num_ele[6];TH1F* h_den_ele[6];TH1F* h_div_ele[6];TH1F* h_div_noEWKcorr_ele[6];
  for(int j=0;j<6;j++){
  ...
  for(int j=0;j<6;j++){
    ...
    h_div_mu[j]->Draw("E"); h_div_mu[j]->GetYaxis()->SetRangeUser(0,1); h_div_mu[j]->SetTitle(Form("Muon FR (jet pt > %dGeV)",j*5+20)); h_div_mu[j]->SetLineColor(2); h_div_mu[j]->GetXaxis()->SetTitle("p_{T} [GeV]"); h_div_mu[j]->GetYaxis()->SetTitle("Mu fake rate");c[0][1][j]->SetGridx(1);c[0][1][j]->SetGridy(1); h_div_mu[j]->SetLineWidth(2); h_div_mu[j]->SetMarkerColor(2);  h_div_mu[j]->SetMarkerStyle(kFullCircle);
    ...
    h_div_eta_mu[j]->Draw("E"); h_div_eta_mu[j]->GetYaxis()->SetRangeUser(0,1); h_div_eta_mu[j]->SetTitle(Form("Muon FR (jet pt > %dGeV)",j*5+20)); h_div_eta_mu[j]->SetLineColor(2); h_div_eta_mu[j]->GetXaxis()->SetTitle("|#eta|"); h_div_eta_mu[j]->GetYaxis()->SetTitle("Mu fake rate");c[2][1][j]->SetGridx(1);c[2][1][j]->SetGridy(1); h_div_eta_mu[j]->SetLineWidth(2); h_div_eta_mu[j]->SetMarkerColor(2);  h_div_eta_mu[j]->SetMarkerStyle(kFullCircle);
  ...
  combinedleg->AddEntry(h_div_ele[0],"jet pt >20 GeV");
  combinedleg->AddEntry(h_div_ele[1],"jet pt >25 GeV");
  combinedleg->AddEntry(h_div_ele[2],"jet pt >30 GeV");
  combinedleg->AddEntry(h_div_ele[3],"jet pt >35 GeV");
  combinedleg->AddEntry(h_div_ele[4],"jet pt >40 GeV");
  combinedleg->AddEntry(h_div_ele[5],"jet pt >45 GeV");
